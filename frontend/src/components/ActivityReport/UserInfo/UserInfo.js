...
function UserInfo({
  ...
  alt,
  userName,
  headRow1 = ["Name", "Start", "Actual", "Goal"],
      ...
      <div className="act-user-profile ">
        ...
        <div className="act-user-info">
          {/* <div className="user-name">
            <p className="font-head ">{userName}</p>
          </div>
          <p className="font-head ">{userName}</p>
          <p className="font-head ">{userName}</p>
          ...
          <table>
                        <thead>
                            ...
                            <tr className="font-detail secondary-text-color middle-font font-sm-detail text-center">
                                <th >&nbsp;</th>
                                <th className="goal-start">Start</th>
                                <th className="goal-actual">Actual</th>
                                <th>Goal</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td className="goal-start font-detail font-sm-detail text-center">{headRow1[1]}</td>
                            ...
                            <tr>
                                ...
                                <td className="goal-start font-detail font-sm-detail text-center">{headRow2[1]}</td>
                            ...
                            <tr>
                                ...
                                <td className="goal-start font-detail font-sm-detail text-center">{headRow3[1]}</td>
